    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("CPLUS-light"), QVariant("light"));
    ui->theme->addItem(QString("CPLUS-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("CPLUS-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("CPLUS-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("CPLUS-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("CPLUS-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("CPLUS-traditional"), QVariant("trad"));
