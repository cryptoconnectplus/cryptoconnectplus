    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  cryptoconnectplus-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the CryptoConnectPlus in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 CPLUS, 0.1 CPLUS, 1 CPLUS and 10 CPLUS -- sort of like the paper money you use every day.</li> \
