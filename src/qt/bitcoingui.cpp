...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CryptoConnectPlus address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cryptoconnectplus: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about CryptoConnectPlus Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CryptoConnectPlus addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CryptoConnectPlus addresses"));
    ...
    openAction->setStatusTip(tr("Open a cryptoconnectplus: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible CryptoConnectPlus command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CryptoConnectPlus network", "", count));
    } else {
...
{
    QString strTitle = tr("CryptoConnectPlus Core"); // default title
    ...
    // Append title to "CryptoConnectPlus Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
