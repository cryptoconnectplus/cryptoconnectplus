...
2. run cryptoconnectplusd with -printalert or -sendalert like this:
   /path/to/cryptoconnectplusd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.cryptoconnectplus.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/CryptoConnectPlus Core:0.12.0.58/"));
