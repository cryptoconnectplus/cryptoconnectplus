...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all CryptoConnectPlus related functionality
...
/*
    ...
    allow endless transaction that would bloat CryptoConnectPlus and make it unusable. To
...
void ThreadCheckPrivateSendServer(CConnman& connman)
{
    ...
    RenameThread("cryptoconnectplus-ps-server");
