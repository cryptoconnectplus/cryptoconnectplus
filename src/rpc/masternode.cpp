...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print CryptoConnectPlus address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "cryptoconnectplus",               "masternode",             &masternode,             true,  {} },
    { "cryptoconnectplus",               "masternodelist",         &masternodelist,         true,  {} },
    { "cryptoconnectplus",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "cryptoconnectplus",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "cryptoconnectplus",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "cryptoconnectplus",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
