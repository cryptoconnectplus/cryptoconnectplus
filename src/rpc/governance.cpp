...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in cryptoconnectplus.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("cryptoconnectplus.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    ...
    { "cryptoconnectplus",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "cryptoconnectplus",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "cryptoconnectplus",               "gobject",                &gobject,                true,  {} },
    { "cryptoconnectplus",               "voteraw",                &voteraw,                true,  {} },
