...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s cryptoconnectplus-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cryptoconnectplus-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cryptoconnectplus transaction") + "\n" +
              "  cryptoconnectplus-tx [options] -create [commands]   " + _("Create hex-encoded cryptoconnectplus transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cryptoconnectplus transaction
