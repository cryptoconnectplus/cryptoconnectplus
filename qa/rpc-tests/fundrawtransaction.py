...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid cryptoconnectplus address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid cryptoconnectplus address" in e.error['message'])
