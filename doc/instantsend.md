...
This mechanism has been integrated into Bitcore-Node-CryptoConnectPlus which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cryptoconnectpluspay/insight-api-cryptoconnectplus#web-socket-api](https://github.com/cryptoconnectpluspay/insight-api-cryptoconnectplus#web-socket-api)
* API: [https://github.com/cryptoconnectpluspay/insight-api-cryptoconnectplus#instantsend-transactions](https://github.com/cryptoconnectpluspay/insight-api-cryptoconnectplus#instantsend-transactions)
...
By default, the CryptoConnectPlus Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CryptoConnectPlus Core daemon:
