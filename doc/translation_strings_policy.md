...
This document provides guidelines for internationalization of the CryptoConnectPlus Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cryptoconnectplus_en.ts` remains unchanged.
